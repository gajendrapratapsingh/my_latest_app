    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Obx(() => controller.pdfGenerateState == PdfGenerateState.Busy ? const Center(child: CircularProgressIndicator(color: AppColors.kGreenColor, strokeWidth: 2.0)) : const SizedBox())
        ],
      ),
