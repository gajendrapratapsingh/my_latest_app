      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            Obx(() => controller.pdfGenerateState == PdfGenerateState.Busy ? Center(child: Container(height: 32, width: 32, child: const CircularProgressIndicator(color: AppColors.kGreenColor, strokeWidth: 2.0))) : const SizedBox())
          ],
        ),
      ),
